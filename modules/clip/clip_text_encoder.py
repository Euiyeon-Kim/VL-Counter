...
from modules.clip.clip_modules import Transformer, LayerNorm


class CLIPTextEncoder(nn.Module):
    def __init__(self, context_length=77, vocab_size=49408, transformer_width=512,
                 transformer_heads=8, transformer_layers=12, embed_dim=512, pretrained=None, **kwargs):
        super().__init__()
...
if __name__ == '__main__':
    clip_txt = CLIPTextEncoder(pretrained='../../pretrained/ViT-B-16.pt')
    clip_txt.init_weights()
